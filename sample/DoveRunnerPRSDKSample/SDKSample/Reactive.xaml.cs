...
namespace DoveRunnerPRSDKSample.SDKSample
{
    public sealed partial class Reactive : Page
    {
        ...
        DoveRunnerPRSDKWrapper PRSDKWrapper;
        ...
        private async void PlayBtn_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrWhiteSpace(url) && !string.IsNullOrWhiteSpace(token))
                {
                    ...
                    info.Url = url;
                    info.Token = token;
                    await PRSDKWrapper.SetPlayReady(mediaElement, info, licenseUrl);
        ...
        private async void SetPlayerSubtitle(Uri mpdUri, ContentInfo content)
        {
            try
            {
                ...
                var subtitleList = await PRSDKWrapper.GetSubtitleLIst(mpdUri, content);
